    ...
    >
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="单词" prop="danci">
          <el-input v-model="ruleForm.danci" 
              placeholder="单词" clearable  :readonly="ro.danci"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单词" prop="danci">
              <el-input v-model="ruleForm.danci" 
                placeholder="单词" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="播放" prop="bofang">
          <file-upload
          tip="点击上传播放"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.bofang" label="播放" prop="bofang">
            <el-button type="text" size="small" @click="download(ruleForm.bofang)">预览</el-button>
          </el-form-item>
        </div>    
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="释义" prop="shiyi">
          <el-input v-model="ruleForm.shiyi" 
              placeholder="释义" clearable  :readonly="ro.shiyi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="释义" prop="shiyi">
              <el-input v-model="ruleForm.shiyi" 
                placeholder="释义" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.fengmian" label="封面" prop="fengmian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.fengmian.split(',')" :src="item" width="100" height="100">
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="例句" prop="liju">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="例句"
                  v-model="ruleForm.liju" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.liju" label="例句" prop="liju">
                    <span>{{ruleForm.liju}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `cihuidanci/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cihuidanciCrossAddOrUpdateFlag = false;
                  this.parent.search();
