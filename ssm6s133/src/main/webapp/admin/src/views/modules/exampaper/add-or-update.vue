<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="习题名称" prop="name">
          <el-input v-model="ruleForm.name" 
              placeholder="习题名称" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="习题名称" prop="name">
              <el-input v-model="ruleForm.name" 
                placeholder="习题名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="练习时长(分钟)" prop="time">
          <el-input v-model="ruleForm.time" 
              placeholder="练习时长(分钟)" clearable  :readonly="ro.time"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="练习时长(分钟)" prop="time">
              <el-input v-model="ruleForm.time" 
                placeholder="练习时长(分钟)" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  data() {
	...
	status : false,
            ...
            ruleForm: {
                    ...
                    rules: {
                  name: [
                            { required: true, message: '习题名称不能为空', trigger: 'blur' },
                                    	                                                              ],
                  time: [
                            { required: true, message: '练习时长(分钟)不能为空', trigger: 'blur' },
